...
float PitchSpeedPid[6] 		= {28000.0f,			1100.0f,			0.0f,		19000.0f,			8000.0f,	0.05f};
...
//	gimbal_y.given_current=0;
	...
	current_give=canTX_gimbal(gimbal_p.given_current,gimbal_y.given_current);
